...
introInHeader: true
about:
  - name: "Een huis kopen als alleenstaande"
    sameAs:
...
Als alleenstaande kun je een huis kopen wanneer je inkomen, eigen inbreng en financiële reserve voldoende zijn voor de aankoop en de maandelijkse aflossing. Je leent op één inkomen, waardoor de verhouding tussen aankoopprijs, lening en vaste lasten zwaarder doorweegt. Bereken daarom eerst je volledige aankoopbudget en behoud een buffer voor werken en onverwachte kosten.
...
De verkoper betaalt doorgaans de vergoeding van de vastgoedmakelaar waarmee hij een bemiddelingsovereenkomst sloot. Er is geen wettelijk commissietarief: het kantoor kan een percentage, vast bedrag en afzonderlijke kosten afspreken, waarop 21% btw geldt. Als koper betaal je die verkoopopdracht normaal niet, tenzij je zelf een afzonderlijke aankoopopdracht geeft.
