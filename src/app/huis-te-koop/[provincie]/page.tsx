// Enkel segment onder /huis-te-koop/: ofwel een provincie-listing, ofwel een woning-detail.
// Provincie-slugs (bv. limburg) -> ProvincieView; woning-slugs (bv. ...-166222) -> detail.
